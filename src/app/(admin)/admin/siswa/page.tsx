...
export default function AdminSiswaPage() {
  useAuth({ required: true, requireAdmin: true });
    ...
    <>
      ...
      <div className="space-y-4 px-4 py-4">
        <p className="px-1 text-xs text-[var(--color-neutral-500)]">
          Daftar siswa untuk mempermudah autocomplete saat pencatatan.
          Bisa <strong>import banyak siswa sekaligus</strong> dari Excel/CSV.
        </p>
      ...
      <ConfirmDialog
        ...
        description={
          <>
            ...
            daftar. Riwayat pengambilan tidak akan hilang.
          </>
        }
